    ...
    return function a(b, c, d) {
        ...
        27: [function(a, b, c) {
                    ...
                    void 0 !== d) {
                        ...
                        i = 0; i < g.length; i++)
                            ...
                            h = 0; h < n.length; h++)
                                ...
                                m > d ? (k = n[h] + " ",
                                o += q.textLeading()) : k = l;
                        switch (this._rectMode === e.CENTER && (b -= d / 2,
                        c -= f / 2),
                        ...
                        for (t === e.CENTER ? s = (g.length - 1) * q.textLeading() / 2 : t === e.BOTTOM && (s = (g.length - 1) * q.textLeading()),
                        j = 0; j < g.length; j++)
                            this._renderText(q, g[j], b, c - s, r),
                            c += q.textLeading()
                    }
                    return p && (this.drawingContext.textBaseline = e.BASELINE),
                    q
                }
            }
            ,
            ...
            d.Renderer2D.prototype.textAlign = function(a, b) {
                if (void 0 !== a)
                    return a !== e.LEFT && a !== e.RIGHT && a !== e.CENTER || (this.drawingContext.textAlign = a),
                    b !== e.TOP && b !== e.BOTTOM && b !== e.CENTER && b !== e.BASELINE || (b === e.CENTER ? this.drawingContext.textBaseline = e._CTX_MIDDLE : this.drawingContext.textBaseline = b),
                    this._pInst;
        ...
        46: [function(a, b, c) {
            ...
            i.prototype.httpDo = function() {
                ...
                var r;
                return r = "jsonp" === a ? j(l, f) : fetch(d),
                r = r.then(function(b) {
                    if (!b.ok) {
